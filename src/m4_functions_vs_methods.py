...
def try_methods_and_functions():
    owo = rg.SimpleTurtle()
    owo.pen = rg.Pen('blue', 5)
    owo.backward(150)
    owo.speed = 1
    draw_many_squares(owo,2,100,30)
    owo.speed = 5
    owo.pen = rg.Pen('Red', 5)
    draw_many_squares(owo,10,50,15)
    owo.speed = 100
    owo.pen = rg.Pen('Red', 35)
    draw_many_squares(owo,8,300,60)
    owo.pen = rg.Pen('black', 3)
    owo.backward(200)
    owo.draw_circle(30)
    owo.draw_square(50)
    """
